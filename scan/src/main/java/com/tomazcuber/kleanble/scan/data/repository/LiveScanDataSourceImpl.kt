    ...
    private val scanCallback =
        object : ScanCallback() {
            ...
            override fun onScanFailed(errorCode: Int) {
                val reason =
                    when (errorCode) {
                        SCAN_FAILED_ALREADY_STARTED -> BleScanError.SCAN_FAILED_ALREADY_STARTED
                        SCAN_FAILED_APPLICATION_REGISTRATION_FAILED -> BleScanError.SCAN_FAILED_APPLICATION_REGISTRATION_FAILED
                        SCAN_FAILED_FEATURE_UNSUPPORTED -> BleScanError.SCAN_FAILED_FEATURE_UNSUPPORTED
                        SCAN_FAILED_INTERNAL_ERROR -> BleScanError.SCAN_FAILED_INTERNAL_ERROR
